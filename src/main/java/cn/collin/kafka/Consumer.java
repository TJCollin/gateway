...
//        String dataType = JSONObject.fromObject(val)
        Long startTime = JSONObject.fromObject(val1).getLong("timestamp");
        Long endTime = JSONObject.fromObject(val2).getLong("timestamp");
...
//        Vertx vertx = Vertx.vertx();
        VertxWeb.vertx.createHttpClient().post(9200, "localhost", "/chain/code/_search?scroll=1m", resp -> {
